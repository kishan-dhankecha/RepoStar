...
class _ReadmePageState extends ConsumerState<ReadmePage> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(readmeNotifierProvider);

    ref.listen<ReadmeState>(readmeNotifierProvider, (prev, cur) {
      cur.maybeWhen(
        orElse: () {},
        loadSuccess: (readme, _) {
          if (!readme.isFresh) showNoConnectionToast(context);
        },
      );
    });
    return Scaffold(
